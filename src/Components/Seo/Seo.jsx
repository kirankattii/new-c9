			...
			<div className="seo">
				<div className="seo-container">
					<div className="seo-header">
						...
						>
							<span> Unlock Your Website's Potential with Expert SEO </span> At
							C9 Ads, we understand that visibility is paramount in the digital
							landscape. That's why our SEO services are not just about
							improving rankings; they're about opening doors to increased
							visibility, engagement, and conversions. Located in Perth, C9 Ads,
							the best search engine optimization company Perth is committed to
							propelling your business to the forefront of search engines, where
							most customers start their online journey.
						</motion.p>
					</div>
					...
					<div className="seo-subContainer2">
						...
						>
							...
							Coupled with extensive keyword research that assesses market
							trends, competitor strategies, and audience intent, our foundation
							is set to tailor a strategy that targets your specific market
							effectively.
						</motion.p>
						<motion.p
							whileInView={{ scale: 1, opacity: 1, x: 0 }}
						...
						>
							...
							detailed keyword strategies, content recommendations, and
							technical improvements that ensure your website aligns perfectly
							with search engine algorithms. Our strategic planning is your
							roadmap to improved rankings and enhanced online visibility.
						</motion.p>
						<motion.p
							whileInView={{ scale: 1, opacity: 1, x: 0 }}
							initial={{ scale: 0.94, opacity: 0, x: -50 }}
						...
						>
							...
							metrics like traffic, engagement, and conversion rates. This
							ongoing analysis helps us refine and adjust strategies to keep up
							with changing algorithms and market dynamics.
						</motion.p>
						<div className="choose-seo">
							...
							>
								<li>
									Results-driven: We focus on achieving measurable improvements
									in your site traffic and search rankings.
								</li>
								<li>
									Experience and Expertise: Our team is skilled in the latest
									SEO techniques and backed by years of experience in diverse
									industries.
								</li>
								<li>
									Custom Solutions: We recognize that each business is unique.
									Our strategies are customized to meet your specific needs and
									goals.
								</li>
							</motion.ul>
						</div>
						...
						<div className="elevateBrandWithC9">
							...
							<motion.p
								...
								transition={{ duration: 0.6 }}
							>
								Investing in SEO with C9 Ads means choosing a partner dedicated
								to your success. Ready to dominate the first page of Google and
								turn searches into conversions? Let’s connect and transform your
								online presence into your most powerful asset
							</motion.p>
						</div>
					</div>
				</div>
