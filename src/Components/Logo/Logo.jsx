			...
			<div className="logo2">
				<div className="logo-container">
					...
					<div className="logo-subContainer1">
						...
						>
							<p>
								...
								identity. At C9 Ads, the best logo designing company Australia,
								we understand that a logo is not just an artistic symbol but the
								foundational element that embodies your brand’s ethos and
								communicates its core values to the audience. That's why our
								best logo designing company in Perth is tailored to create
								distinctive, memorable, and meaningful logos that resonate with
								your target market.
							</p>
							<h2>Logo Design</h2>
					...
					<div className="logo-subContainer2">
						...
						>
							<li>
								<b>Make Your Mark:</b> The right logo leaves a lasting
								impression, often being the first point of engagement with your
								customers. It's an opportunity to instantly convey the
								professional excellence and unique character of your brand.
							</li>
							<li>
							...
							<li>
								...
								logo can set you apart, making your brand easily recognizable
					...
					<div className="logo-subContaine3">
						<div>
							...
							>
								...
								below or give us a call to discuss how we can transform your
								logo into a powerful emblem of your business.
							</motion.p>
						</div>
					</div>
				</div>
