...
const SocialMedia2 = () => {
	...
	return (
		<>
			<Helmet>
				<title>
					SEO Meta Title: Boost Your Online Presence with Expert Social Media
					Marketing | Perth
				</title>
				<meta
					name="description"
					content="Enhance your brand and engage with your audience by implementing expert social media marketing strategies in Perth. Let us help you Grow your online presence today."
				/>
			</Helmet>
			<div className={styles.Allcontainer}>
									...
									<div className={styles.digitalMarketing}>
										...
										<div className={styles.degitalMarketingProcesses}>
											<div>
												...
												<p>
													We define a compelling brand identity and strategy
													based on deep industry and competitor analysis for
													maximum impact.
												</p>
											</div>
											<div>
											...
											<div>
												<h3>
													Targeted Social Media Campaigns and Digital
													Advertising:
												</h3>
												<p>
													We execute targeted social media and digital
													advertising campaigns to broaden your reach and engage
													potential customers.
												</p>
											</div>
										</div>
				...
				<div className={styles.horizontalmotion2}>
					<div className={styles.newScroll1}>
						<img
							className={styles.marketingGif2}
							ref={videoRef}
							src={assets.socialMediaGif}
							alt=""
						/>
					</div>
					<div className={styles.newScroll2}>
						<video
							// width="330"
							// height="360"
							controls
					...
					<div className={styles.newScroll3}>
						<video
							// width="330"
							// height="360"
							controls
						...
						<h3>Content Marketing</h3>
						<p>
							We create and distribute valuable content—from blogs to videos—to
							attract and retain your target audience, driving profitable
							actions.
						</p>
					</div>
					<div className={styles.newScroll4}>
						<video
							// width="330"
							// height="360"
							controls
						...
						<p>
							...
							your dedicated digital marketing partner, allowing you to focus on
							running your business.
						</p>
					</div>
					<div className={styles.newScroll5}>
						<div>
							<h3>Strategic Branding and Positioning:</h3>
							<p>
						...
						<div>
							...
							<p>
								We execute targeted social media and digital advertising
								campaigns to broaden your reach and engage potential customers.
							</p>
						</div>
					</div>
				</div>
