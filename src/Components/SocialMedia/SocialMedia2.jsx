		...
		<div className={styles.Allcontainer}>
			...
			<div className={styles.horizontalmotion2}>
				...
				<div className={styles.newScroll2}>
					...
					<p>
						Using platforms like Facebook, Instagram, and LinkedIn, we
						strategically position your brand to maximize reach and engagement.
					</p>
				</div>
				<div className={styles.newScroll3}>
					...
					<p>
						...
						attract and retain your target audience, driving profitable actions.
					</p>
				</div>
				<div className={styles.newScroll4}>
					...
					<h3>Your Dedicated Digital Partner</h3>
					<p>
						Whether you're a startup or an established business, C9 Ads is your
						dedicated digital marketing partner, allowing you to focus on
