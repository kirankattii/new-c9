...
const SocialMedia = () => {
	...
	return (
		<>
			<Helmet>
				<title>
					Best Social Media Marketing Company in Australia | Social Media
					Marketing Company in Perth
				</title>
				<meta
					name="description"
					content="C9 ADS is a one-stop destination for social media marketing, helps in increasing your organic traffic on social media with our creativity."
				/>
			</Helmet>
			<div
				ref={container}
					...
					<div className="socialmedia-subContainer1">
						<div className="socialMedai-bgVideo">
							...
							<p className="socialMedia-content1">
								We optimize your content to rank higher in search engine
								...
								<div className="socialmedia-videoContent1-middle">
									<ul>
										<li>
											...
											<p>
												Using platforms like Facebook, Instagram, and LinkedIn,
												we strategically position your brand to maximize reach
												and engagement.
											</p>
										</li>
										<li>
											...
											<p>
												...
												videos—to attract and retain your target audience,
										...
										<li>
											...
											<p>
												...
												Ads is your dedicated digital marketing partner,
						...
						<ul>
							...
							<li>
								...
								<p>
									...
									your dedicated digital marketing partner, allowing you to
